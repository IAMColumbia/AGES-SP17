...
public class PlayerController : MonoBehaviour
{
    ...
    void PlayerShooting()
    {
        ...
        {
            Bullet tempBullet;
            tempBullet = Instantiate(bulletPrefab, bulletOrigin1.transform.position, bulletOrigin1.transform.rotation) as Bullet;
            Bullet tempBullet2;
            tempBullet2 = Instantiate(bulletPrefab, bulletOrigin2.transform.position, bulletOrigin2.transform.rotation) as Bullet;
