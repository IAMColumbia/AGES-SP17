...
public class BoardManager : MonoBehaviour
{
    ...
    void LayoutObjectAtRandomPosition(GameObject[] tileArray, int minimum, int maximum)
    {
    ...
    public void SetupScene(int level)
    {
        BoardSetup();
        InitializeList();
        LayoutObjectAtRandomPosition(wallTiles, wallCount.minimum, wallCount.maximum);
